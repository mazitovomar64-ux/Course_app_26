...
from .models import (UserProfile,Teacher,NetworkTeachers,
                     Category,Subcategory,Language,Course,
                     Chapter,Student,NetworkStudent,
                     Lesson,Assignment,Exam,Question,Option,
                     Certificate,Review,ReviewLike)
...
class SubcategorySerializer(serializers.ModelSerializer):
    sub_category = CategorySerializer(many=True, read_only=True)
    class Meta:
        model = Subcategory
...
class CourseListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = ['id','course_name','description','level','language','price','avg_rating',
                  'count_people','student_count','created_by','course_photo','is_certificate']
...
class LessonSerializer(serializers.ModelSerializer):
    class Meta:
        model = Lesson
        fields = ['id','lesson_name','lesson_image','lesson_video',
                  'lesson_file','content','has_assignment']
...
class LessonDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Lesson
        fields = ['id','lesson_name','lesson_image','lesson_video',
                  'lesson_file','content','lesson_assignment']
...
class ChapterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Chapter
        fields = ['id','chapter_name','lesson_count','chapter_lesson','chapter_exam']
...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Review
        fields = ['id','student','rating','likes','dis_likes','text','created_date']
...
class CourseDetailSerializer(serializers.ModelSerializer):
    ...
    rating_course = ReviewSerializer(read_only=True,many=True)
    class Meta:
        model = Course
        fields = ['id','course_name','description','level','language','price',
                  'is_certificate','created_by','subcategory','chapters','rating_course']
